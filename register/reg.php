		...
		<div class="form-v9-content" style="background-image: url('images/form-v9.jpg')">
			<form class="form-detail" action="ureg_action.php" method="post">
				...
				<div class="form-row-total">
					<div class="form-row">
						<input type="text" name="full-name" id="full-name" class="input-text" placeholder="Your Name" required pattern="">
					</div>
					<div class="form-row">
				...
				<div class="form-row-last">
					...
					<p>Already have an account ? <a href="C://xampp//htdocs//project//register//login//index.php">Sign in</a></p>
				</div>
			</form>
		</div>
	</div>
