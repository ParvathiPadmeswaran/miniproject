                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <br>
                            <h5 class="text-white text-uppercase mb-md-3">Sign Language Recognition System</h5>
                            <h3 class="display-1 text-white mb-md-4">Text To Sign Language </h3>
                            <center><form action="" style="width: 30%; padding: 10px;" method="POST" enctype="multipart/form-data">
    
Enter the text here <input   type="textbox"  style="text-align: center;" name="sign"   id="sign"  class='form-control' autocomplete="off" required="on"><br>
     ...
     <?php
         if(isset($_POST['Submit']))
         {
            ...
            {
                if($value==" "){
                $target_path = "output/space7.jpg";
                //echo "$sign";
                echo "<img src='$target_path' width='80' height='80'></img>";
                //echo "$value <br>"
                }
                else{
                
                $target_path = "output/".$value.".jpeg";
                //echo "$sign";
                echo "<img src='$target_path' width='80' height='80'></img>";
                //echo "$value <br>"
...
{
    echo "<h3 style='color:white'>No Internet for audio translations!</h3>";
}
else
{
$sign=htmlspecialchars($sign);
  $sign1=rawurlencode($sign);
  $audio=file_get_contents('https://translate.google.com/translate_tts?ie=UTF-8&client=gtx&q='.$sign1.'&tl=en-IN');
  $sss="<br><br><br><center><audio controls='controls' autoplay><source src='data:audio/mpeg;base64,".base64_encode($audio)."'></audio></center><br><br>";
  echo $sss;
}
