...
<body>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                          ...
                          <h1 class="text-white  text-center mb-5">Welcome To Our Services</h1>
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0"><a href="sign_to_text.php">Sign language to text</a></h4>
                    </div>
                </div>
 ...
 <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center  p-4 mb-4" style="height: 150px;">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary ml-n4 mr-4" style="">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class=" text-uppercase m-0"><a href="text_to_sign.php">Text to sign lanuage</a></h4>
                    </div>
                </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-secondary p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-light text-uppercase m-0"><a href="text_to_sign.php">text to sign lanuage</a></h4>
                    </div>
                </div>
