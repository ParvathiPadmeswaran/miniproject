                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4">Live Converter</h1>
                          <center>  <form action="" style="width: 30%; padding: 10px;" method="POST" enctype="multipart/form-data">

 
 
     <div class="text-center"><input type="Submit" name="Submit" value="Start Webcam" class='btn btn-primary' id="p1"></div><br>
     </form></center>



<div class="text-center"><a class='btn btn-primary' href="sign_to_text.php">Go Back...</a></div>
